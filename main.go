...
import (
	"flag"
	controller2 "k8s-controller-custom-resource/controller"
...
func main() {
	...
	//kubeClientDebug := &kubernetes.Clientset{}
	kubeClient, err := kubernetes.NewForConfig(cfg)
	if err != nil {
		glog.Fatalf("Error building kubernetes clientset: %s", err.Error())
	}

	//networkClientDebug := &clientset.Clientset{}
	...
	controller := controller2.NewController(kubeClient, networkClient,
